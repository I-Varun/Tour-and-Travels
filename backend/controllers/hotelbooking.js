...
<<<<<<< HEAD
    const { user_id, hotel_id, amount, check_in_date,check_out_date,name,email,phone_no,rooms,booking_status } = req.body;
    ...
    db.query(
      ...
      [user_id, hotel_id, amount, check_in_date,check_out_date,name,email,phone_no,rooms,booking_status],
      (error, results) => {
        if (error) {
