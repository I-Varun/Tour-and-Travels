...
const BookedTours = () => {
  ...
  const handleCancelConfirmation = async () => {
    try {
      ...
      setRefundMessage(
        `We have successfully processed your refund for the cancelled booking. As per our policy, ${refundPercentage}% of the tour amount has been deducted, and the remaining ₹${price - refundedAmount} has been refunded to your account. You will receive the refund within the next 5-7 business days. Thank you for choosing Trip-Trekker, and we hope to serve you better in the future.`
      );
      ...
      {tourDetails && (
        ...
        >
          ...
          <ModalContent>
            ...
            <ModalFooter>
              <Button colorScheme="blue" onClick={() => setRefundModalOpen(false)}>
                Close
              </Button>
            </ModalFooter>
          </ModalContent>
